...
export const nextDrawings = query(
...
export const nextAnimations = query(
...
export const adminInGroups = (userId: string) =>
  query(groupRef, where('admin', '==', userId), orderBy('name'), limit(maxItems));
...
export const addingPostComment = (name: GroupNameType, idPost: string) =>
  collection(db, `groups/${name}/posts/${idPost}/comments`);

export const postsComments = (name: GroupNameType, idPost: string) => {
  return query(collection(db, `groups/${name}/posts/${idPost}/comments`), orderBy('date', 'desc'));
};
...
export const docLastPostsComments = (
  name: GroupNameType,
  idPost: string,
  idComment: string,
  idSubComment: string,
  ...
  return doc(
    db,
    `groups/${name}/posts/${idPost}/comments/${idComment}/subcomments/${idSubComment}/lastcomments/${idLastComment}`,
  );
};
...
//FILE LASTCOMMENTS
export const subLastFilesComments = (
  uid: string,
  subCollection: string,
  idPost: string,
  idComment: string,
  ...
  return collection(
    db,
    `users/${uid}/${subCollection}/${idPost}/comments/${idComment}/subcomments/${idSubComment}/lastcomment`,
  );
};

export const docLastFilesComment = (
  userId: string,
  subCollection: string,
  idPost: string,
  idComment: string,
  ...
  return doc(
    db,
    `users/${userId}/${subCollection}/${idPost}/comments/${idComment}/subcomments/${idSubComment}/lastcomment/${idLastComment}`,
  );
};
