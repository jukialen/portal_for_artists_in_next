  ...
  return (
    <section className='workspace'>
      ...
      <p className={styles.param}>
        ...
        eu pharetra. Duis rutrum molestie arcu ac lacinia. Mauris rutrum hendrerit augue a condimentum. Nulla at ligula
      ...
      <p className={styles.param}>
        10) Nam eleifend ipsum est, ac pretium dolor laoreet nec. Etiam commodo ligula nec odio lacinia
        Phasellus et placerat quam, nec luctus neque. Donec et semper magna. Donec ullamcorperneque vel enim faucibus
        scelerisque. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis
        egestas. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Quisque
        ullamcorper lorem tristique dui tristique, sit amet mattis diam aliquam. Vivamus in sem id purus blandit
        vestibulum.
      </p>
      ...
      <p className={styles.param}>
        ...
        tempus non odio. Maecenas vitae volutpat libero, euismod consectetur metus. Donec augue ex, posuere ut pharetra
        non, tempus sollicitudin libero. Nunc nec finibus sem. Phasellus at lacus eu enim condimentum commodo nec
        tincidunt urna.
      </p>
      ...
      <p className={styles.param}>
        ...
        suscipit, dolor mauris accumsan nisl, at lobortis libero nisl ac odio. Aenean sodales semper lacus, a
        varius ligula ullamcorper id. Suspendisse erat massa, venenatis eget ipsum sed, ullamcorper fermentum sapien.
      ...
      <p className={styles.param}>
        ...
        placerat. Donec sed nisi et purus imperdiet congue. Pellentesque habitant morbi tristique senectus et netus
        et malesuada fames ac turpis egestas. Suspendisse rutrum aliquet tortor, vel porta risus feugiat eget. Praesent
      ...
      <p className={styles.param}>
        30) Sed ut auctor purus, eget tincidunt orci. Fusce imperdiet metus sit amet tortor commodo hendrerit. Nam
        a ante velit. Proin mattis dolor nec faucibus rutrum. Cras quis nisi condimentum, tempus nulla ut, efficitur
      ...
      <p className={styles.param}>
        ...
        sed elit eleifend maximus. Nunc non tempor purus. Maecenas id dui eget lectus tincidunt semper at a dui. Etiam
        a turpis diam. Morbi laoreet bibendum magna, non finibus nibh pellentesque vitae. Pellentesque lacinia hendrerit
