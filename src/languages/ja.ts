export default {
  ...
  NavForm: {
    ...
    successInfoRegistration:
      'おめでとうございます！登録するのはしてました。 メールの受信箱を確認し、メールを確認してログインします。',
  ...
  Main: {
    ...
    secondQuestion:
      'Are oyu searching a service will hold up as graphical diary? And maybe do you want to show off your artistic works?',
  ...
  AnotherForm: {
    ...
    file: 'ファイル',
    send: '送る',
    uploadFile: 'ファイルがアップロードされました。',
    notUploadFile: 'ファイルがアップロードされませんでした。',
    fileTooLarge: 'ファイルが大きすぎます',
    unsupportedFileType: 'サポートされていないファイル形式',
    fileSelectionCancelled: 'ファイルの選択がキャンセルされました',
    errorOpeningFilePicker: 'ファイル選択ウィンドウを開く際にエラーが発生しました',
  },
  AddingGroup: {
  ...
  Contact: {
    ...
    subTitleFirst:
      'もし、オピニオンか誤りが呉れたいです、このおかげで、フォーマットが送りますくだし。このサービスは加筆私の手伝ってます。',
    toFAQ: 'そちら様も',
    toFAQHere: 'よくあるご質問',
    dot: '見えます。',
    chooseTitle: '題が選ぶ',
    ...
    problem: '問題',
    success:
      'メールが送りました。メッセージ有り難うございました。 出来るのは限り早期,この問題はこの発案が考えますか私が扱います。',
  ...
  FAQ: {
    ...
    body4:
      '「アカウント」サブページの最初のブックマークにある「消します」ボタンをクリックするのと選択を確定するだけです。確認後、すべてのデータの削除が始まります。',
  },
  DeletionAccount: {
    button: '消します',
    title: 'アカウントが消します',
  ...
  EmailVerification: {
    ...
    expired:
      '認証コードの有効期限が切れているか、無効になっています。ボタンをクリックして、新しい確認用Eメールリンクを再度送信してください。',
    verified: 'メールを確認しました。',
  },
  Settings: {
    title: '設定',
