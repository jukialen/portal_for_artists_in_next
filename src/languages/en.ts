export default {
  ...
  NavForm: {
    ...
    successInfoRegistration:
      "Congratulation! You are registered. Check your mailbox and confirm your e-mail in order to you'll can sign in.",
  ...
  Contact: {
    ...
    subTitleFirst:
      'If you want to give the opinion or a problem, send form. Thanks to these messages, you help me to improvement this service.',
    ...
    problem: 'Problem',
    success:
      "E-mail was sent. I thank you for the message.  As soon as possible, I'll deal with the problem or consider the suggestion.",
  ...
  FAQ: {
    ...
    body1:
      'Yes. The service can be used free of charge. However, to take advantage of the additional benefits, PREMIUM or GOLD plan must be purchased.',
    head2: 'What benefits do the PREMIUM and GOLD PLANS offer?',
    body2:
      'That plans provide client support (priority - GOLD) and smaller files size limits. You can find out more about the plans ',
    body2Link: 'here',
    body2dot: '.',
    ...
    body4:
      "All you need to do is click in the 'Delete' button at the bottom of page in first bookmark of Account subpage and confirm your selection. After confirm, the deletion all your data begins.",
  },
  DeletionAccount: {
    button: 'Delete',
  ...
  EmailVerification: {
    ...
    expired:
      'The verification code is expired or invalid. Please click the button to send new email verification link again.',
