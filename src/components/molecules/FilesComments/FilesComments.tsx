...
=======
import { getCurrentLocale, getScopedI18n } from 'src/locales/server';

import { dateData } from 'src/helpers/dateData';

import { FilesCommentsClient } from 'src/components/organisms/FilesCommentsClient/FilesCommentsClient';
