  ...
  try {
    ...
    for (const first of data!) {
      ...
      lastCommentArray.push({
        ...
        authorId,
        likes: (await likeList(authorId, lastCommentId))!.likes,
        liked: (await likeList(authorId, lastCommentId))!.liked,
        idLiked: (await likeList(authorId, lastCommentId))!.idLiked,
