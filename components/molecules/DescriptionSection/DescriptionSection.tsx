        ...
        {({ values, handleChange, errors, touched }) => (
          <Form className={styles.form}>
            <Textarea
              ...
              className={!!errors.newDescription && touched.newDescription ? styles.updateField__error : styles.updateField}
            />
        ...
        {({ values, handleChange, errors, touched }) => (
          <Form className={styles.form}>
            <Textarea
              ...
              placeholder={data?.Description?.textPlaceholder}
              aria-label={data?.Description?.textAria}
              className={!!errors.newRegulation && touched.newRegulation ? styles.updateField__error : styles.updateField}
            />
